<template>
  <div id="article">
      ...
      <div id="grid">
      <section id="picture">
        <img class="capture capture-1" v-lazy="require('@/assets/detail_article/img_' + description.id + '-1.jpg')" />
        <img v-if="description.type !== 'photo'" class="capture capture-2" v-lazy="require('@/assets/detail_article/img_' + description.id + '-2.png')"/>
      </section>
